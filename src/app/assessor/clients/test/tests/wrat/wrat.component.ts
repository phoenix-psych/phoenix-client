...
export class WratComponent implements OnInit {
  ...
  onSave(){
    const body = {
      ...
      wrRawScore : this.wrRawScore?.toString(),
      wrStandardScore : this.wrStandardScore?.toString() == "" ? "0" : this.wrStandardScore?.toString(),
      wrCI : this.wrCI?.toString(),
      wrPer : this.wrPer?.toString(),
      wrGrade : this.wrGrade?.toString(),
      spRawScore : this.spRawScore?.toString(),
      spStandardScore : this.spStandardScore?.toString() == "" ? "0" : this.spStandardScore?.toString(),
      spCI : this.spCI?.toString(),
      spPer : this.spPer?.toString(),
      spGrade : this.spGrade?.toString(),
      mcRawScore : this.mcRawScore?.toString(),
      mcStandardScore : this.mcStandardScore?.toString() == "" ? "0" : this.mcStandardScore?.toString(),
      mcCI : this.mcCI?.toString(),
      mcPer : this.mcPer?.toString(),
      mcGrade : this.mcGrade?.toString(),
      scRawScore : this.scRawScore?.toString(),
      scStandardScore : this.scStandardScore?.toString() == "" ? "0" : this.scStandardScore?.toString(),
      scCI : this.scCI?.toString(),
      scPer : this.scPer?.toString(),
      scGrade : this.scGrade?.toString(),
      rcRawScore : this.rcRawScore?.toString(),
      rcStandardScore : this.rcStandardScore?.toString() == "" ? "0" : this.rcStandardScore?.toString(),
      rcCI : this.rcCI?.toString(),
      rcPer : this.rcPer?.toString(),
      rcGrade : this.rcGrade?.toString(),
